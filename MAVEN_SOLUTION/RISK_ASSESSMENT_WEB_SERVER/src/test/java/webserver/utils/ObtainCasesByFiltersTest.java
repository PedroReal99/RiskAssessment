...
import webserver.http.requestHandler.ConcludedCasesRequestHandler;

/**
 *
 * @author joaoflores
 */
public class ObtainCasesByFiltersTest {
    ...
    public ObtainCasesByFiltersTest() {
    }
    ...
    /**
     * Test of getCaseResultsFilteredByTimeInterval method, of class
     * ObtainCasesByFilters.
     */
    @Test
    public void testGetCaseResultsFilteredByTimeInterval() throws Exception {
        System.out.println("getCaseResultsFilteredByTimeInterval");
        ...
        ObtainCasesByFilters cc = new ObtainCasesByFilters();
        List<CaseI> result = cc.getCaseResultsFilteredByTimeInterval(new CaseDate("06/06/2006"), new CaseDate("23/12/2020"), allCasesByState);
    ...
    public void testGetCaseResultsFilteredByCities() {
        ...
        expResult.add(instance6);
        ObtainCasesByFilters cc = new ObtainCasesByFilters();
        List<CaseI> result = cc.getCaseResultsFilteredByCities(cities, allCasesByState);
        assertEquals(expResult, result);
    }

    /**
     * Test of getCaseResultsFilteredByTimeIntervalAndCities method, of class
     * ObtainCasesByFilters.
     */
    @Test
    public void testGetCaseResultsFilteredByTimeIntervalAndCities() throws Exception {
        ...
        expResult.add(instance6);
        ObtainCasesByFilters cc = new ObtainCasesByFilters();
        List<CaseI> result = cc.getCaseResultsFilteredByTimeIntervalAndCities(new CaseDate("06/06/2006"), new CaseDate("23/12/2020"), cities, allCasesByState);
        assertEquals(expResult, result);
    }

    /**
     * Test of convertStringToDate method, of class ObtainCasesByFilters.
     */
    @Test
    public void testConvertStringToDate() throws Exception {
        System.out.println("convertStringToDate");
        CaseDate date = new CaseDate("06/06/2006");
        SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy", Locale.ENGLISH);
        Date expResult = formatter.parse(date.toString());
        Date result = ObtainCasesByFilters.convertStringToDate(date);
        assertEquals(expResult, result);
    }
